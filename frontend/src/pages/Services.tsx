...
export default function Services() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      {/* ─── Пустое состояние (загружено, но ничего не найдено) ─── */}
      ...
      {!loading && !error && filtered.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {filtered.map(service => (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className={`w-14 h-14 rounded-xl ${service.color} flex items-center
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className={`inline-block mt-1.5 text-xs px-2 py-0.5 rounded-full
                                   font-medium ${CATEGORY_BADGE[service.category]}`}>
