...
// Первые 6 услуг для блока «Популярные направления»
...
const HOW_IT_WORKS = [
  {
    ...
    desc: 'Найдите нужного врача или исследование в каталоге',
  },
  {
    step: '2',
    title: 'Выберите время',
    desc: 'Выберите удобный день и свободный временной слот',
  },
  {
    step: '3',
    title: 'Получите подтверждение',
    desc: 'Мы пришлём напоминание в Telegram за 24 часа до приёма',
  },
]
